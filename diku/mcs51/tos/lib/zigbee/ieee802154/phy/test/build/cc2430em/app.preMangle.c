...
static void TestStdControlP$SplitControl$startDone(error_t error);
#line 138
static void TestStdControlP$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void TestStdControlP$Boot$booted(void );
...
static error_t PhyP$SplitControl$start(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t PhyP$Init$init(void );
# 43 "../HALCC2420.nc"
static void PhyP$HALCC2420$sendPacketDone(uint8_t *packet, error_t result);
...
static uint8_t *PhyP$HALCC2420$receivedPacket(uint8_t *packet);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void PhyP$sendDone_task$runTask(void );
#line 75
static void PhyP$stopDone_task$runTask(void );
#line 75
static void PhyP$startDone_task$runTask(void );
#line 75
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t TestStdControlP$SplitControl$start(void );
# 6 "TestStdControlP.nc"
static inline void TestStdControlP$Boot$booted(void );



static inline void TestStdControlP$SplitControl$startDone(error_t error);


static inline void TestStdControlP$SplitControl$stopDone(error_t error);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void PhyP$SplitControl$startDone(error_t error);
#line 138
static void PhyP$SplitControl$stopDone(error_t error);
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
static error_t PhyP$HALCC2420Control$start(void );
# 81 "../PhyP.nc"
enum PhyP$__nesc_unnamed4277 {
#line 81
  PhyP$startDone_task = 0U
};
#line 81
typedef int PhyP$__nesc_sillytask_startDone_task[PhyP$startDone_task];
enum PhyP$__nesc_unnamed4278 {
#line 82
  PhyP$stopDone_task = 1U
};
#line 82
typedef int PhyP$__nesc_sillytask_stopDone_task[PhyP$stopDone_task];
enum PhyP$__nesc_unnamed4279 {
#line 83
  PhyP$sendDone_task = 2U
};
#line 83
typedef int PhyP$__nesc_sillytask_sendDone_task[PhyP$sendDone_task];
#line 54
static inline void PhyP$HALCC2420$sendPacketDone(uint8_t *packet, error_t result);


static inline uint8_t *PhyP$HALCC2420$receivedPacket(uint8_t *packet);
#line 73
error_t PhyP$sendErr = SUCCESS;
#line 90
static inline error_t PhyP$Init$init(void );
#line 109
static inline error_t PhyP$SplitControl$start(void );
#line 145
static inline void PhyP$startDone_task$runTask(void );


static inline void PhyP$sendDone_task$runTask(void );
...
static inline void PhyP$stopDone_task$runTask(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
...
#line 83
  HalCC2430RadioP$setChannelTask = 5U
};
#line 83
...
#line 472
  HalCC2430RadioP$receivedPacketTask = 6U
};
#line 472
...
#line 473
  HalCC2430RadioP$flushBufferTask = 7U
};
#line 473
...
#line 158
#line 147
typedef struct HalCC2430RadioP$__nesc_unnamed4290 {
...
static inline void HalCC2430RadioP$CC2430RFEnable(void );
...
static inline void HalCC2430RadioP$CC2430TxWait(void );
...
#line 43
  PhyP$HALCC2420$sendPacketDone(packet, result);
#line 43
}
#line 43
...
#line 53
  __nesc_result = PhyP$HALCC2420$receivedPacket(packet);
#line 53
...
inline static void PhyP$SplitControl$stopDone(error_t error){
#line 138
  TestStdControlP$SplitControl$stopDone(error);
#line 138
}
#line 138
# 155 "../PhyP.nc"
...
#line 155
{
  ...
  PhyP$SplitControl$stopDone(SUCCESS);
}
...
#line 62
  __nesc_result = ecombine(__nesc_result, HalCC2430SimpleUartP$Init$init());
#line 62
  __nesc_result = ecombine(__nesc_result, StdOutM$Init$init());
#line 62
  __nesc_result = ecombine(__nesc_result, HalCC2430RadioP$Init$init());
#line 62
  __nesc_result = ecombine(__nesc_result, PhyP$Init$init());
#line 62
...
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static void PhyP$SplitControl$startDone(error_t error){
#line 113
  TestStdControlP$SplitControl$startDone(error);
#line 113
}
#line 113
...
# 95 "/opt/tinyos-2.1.2/tos/interfaces/StdControl.nc"
inline static error_t PhyP$HALCC2420Control$start(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
#line 109
{
  ...
  PhyP$HALCC2420Control$start();
  PhyP$SplitControl$startDone(SUCCESS);

  return SUCCESS;
}

# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t TestStdControlP$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104

#line 104
  __nesc_result = PhyP$SplitControl$start();
#line 104
...
#line 6
{
  TestStdControlP$SplitControl$start();
}

# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
inline static void RealMainP$Boot$booted(void ){
#line 60
  TestStdControlP$Boot$booted();
#line 60
}
#line 60
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ab5a42bc3c8){
#line 75
  switch (arg_0x2ab5a42bc3c8) {
#line 75
    case PhyP$startDone_task:
#line 75
      PhyP$startDone_task$runTask();
#line 75
      break;
#line 75
    case PhyP$stopDone_task:
#line 75
      PhyP$stopDone_task$runTask();
#line 75
      break;
#line 75
    case PhyP$sendDone_task:
#line 75
      PhyP$sendDone_task$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x2ab5a42bc3c8);
#line 75
      break;
#line 75
    }
